const EventsSection = () => {
    return (
        <div className="w-full h-96 px-10 justify-start items-start gap-3 inline-flex flex-wrap">
        <div className="grow shrink basis-0 h-96 flex-col justify-center items-center gap-6 inline-flex bg-cover "style={{ backgroundImage: 'url(/EventsFoto/bild1.jpg)' }}>
        ...
        <div className="grow shrink basis-0 h-96 flex-col justify-center items-center gap-6 inline-flex bg-cover"style={{ backgroundImage: 'url(/EventsFoto/bild2.jpg)' }}>
        ...
        <div className="grow shrink basis-0 h-96 flex-col justify-center items-center gap-6 inline-flex bg-cover"style={{ backgroundImage: 'url(/EventsFoto/bild3.jpg)' }}>
