...
const TopMenu = () => {
  return (
      <div className="w-full border-b border-zinc-300 ">
        <div
            className="w-full h-14 sm:container  justify-between items-center flex gap-4">
          <div className=" hidden sm:w-fit sm:justify-start sm:items-start sm:flex">
            <div className="px-3 py-5 flex-col justify-start items-start gap-3 inline-flex">
              <div
                  className="text-center text-neutral-800 text-xs font-normal font-['Maison Neue'] leading-none tracking-tight cursor-pointer">
                Women
              </div>
            </div>
